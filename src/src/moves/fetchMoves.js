async function getMoves(Moves){
    ...
    const rawMoves = await fetch(`https://raw.githubusercontent.com/${repo}/battle_moves.h`)
...
async function getMovesDescription(Moves){
    ...
    const rawMovesDescription = await fetch(`https://raw.githubusercontent.com/${repo}/move_descriptions.h`)
