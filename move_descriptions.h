...
static const u8 sWithdrawDescription[] = _(
    "Raises user defensive stats\n"
    "and lowers offensive stats.");
...
static const u8 sPresentDescription[] = _(
    "A gift bomb for foes or\n"
    "healing gift for allies.");
...
static const u8 sCOILDescription[] = _(
    "Up to raise Atk, Def, Acc.\n"
    "Up next bite priority.");
...
static const u8 sSNAP_TRAPDescription[] = _(
    "Type changes on terrains.\n"
    "Traps for 4 to 5 turns.");
...
static const u8 sFROZEN_TERRAINDescription[] = _(
    "Freezes the ground for\n"
    "5 turns. May slip on ice.");

static const u8 sCURSED_TERRAINDescription[] = _(
    "Curses the ground for\n"
    "5 turns. Prevents healing.");

static const u8 sRAVINE_TERRAINDescription[] = _(
    "Summons a ravine for\n"
    "5 turns. Reduce damage.");

static const u8 sBURNING_TERRAINDescription[] = _(
    "Burns the ground for\n"
    "5 turns. Damages each turn.");

static const u8 sSANDY_TERRAINDescription[] = _(
    "The ground become sandy for\n"
    "5 turns. Lowers evasion.");

static const u8 sSWAMP_TERRAINDescription[] = _(
    "The ground become a swamp\n"
    "for 5 turns. Reduces Speed.");

static const u8 sVENOMOUS_TERRAINDescription[] = _(
    "Intoxicate the ground\n"
    "for 5 turns. Poisons.");
...
static const u8 sSHIELD_BASHDescription[] = _(
    "Does more damage the\n"
    "higher the user's Def.");

static const u8 sDRAGON_BONEDescription[] = _(
    "Double power if the user\n"
    "moves before the target.");

static const u8 sDRACO_IMPACTDescription[] = _(
    "A 2-turn move that raises\n"
...
static const u8 sCHRISTMAS_GIFTDescription[] = _(
    "Summons the Christmas in\n"
    "the battlefield.");

static const u8 sARTIC_GLIDEDescription[] = _(
    "Gliding on ground, hits. Goes\n"
    "first on Frozen Terrain.");

static const u8 sCOIN_SHOWERDescription[] = _(
    "Throws coins at the foe.\n"
    "Money is recovered after.");

static const u8 sMAMMOTH_MASHDescription[] = _(
    "A full-body slam that lowers\n"
    "the user speed.");

static const u8 sBERRY_BELLY_FLOPDescription[] = _(
    "Eats an Oran Berry before\n"
    "the full-body slam.");

static const u8 sNAP_SLAMDescription[] = _(
    "Can be while asleep. Deals\n"
    "double damage.");

static const u8 sPOWER_NAPDescription[] = _(
    "The user rests for 2 turns,\n"
    "and attacks while asleep.");

static const u8 sSEISMIC_SLAMDescription[] = _(
    "Takes the foe into the sky\n"
    "then drops it the next turn.");

static const u8 sBARRAGE_BLOWDescription[] = _(
...
static const u8 sAURA_CANNONDescription[] = _(
    "Attacks with an aura blast\n"
    "that cannot be evaded.");

static const u8 sRINGS_UNBOUNDDescription[] = _(
    "Changes to Unbound form\n"
    "and increases stats.");
...
static const u8 sFAIRY_SINGULARITYDescription[] = _(
    "Damages, traps and in the\n"
    "next turn damages again.");

static const u8 sMIDNIGHT_SLASHDescription[] = _(
    "This attack always results\n"
    "in a critical hit.");

static const u8 sPHANTOM_AMBUSHDescription[] = _(
    "Vanishes on the first turn\n"
    "then strikes the next turn.");

static const u8 sFLAME_SWEEPDescription[] = _(
    "May burn the foe, hurts\n"
    "user and boosts Speed.");

static const u8 sWATERBURST_SHURIKENDescription[] = _(
    "A big shuriken that\n"
...
static const u8 sUNDERGROUND_BITEDescription[] = _(
    "Digs underground the first\n"
    "turn and bites next turn.");

static const u8 sINK_JETDescription[] = _(
    "Lowers the foe's Accuracy,\n"
    "then switches out.");

static const u8 sAQUA_TORNADODescription[] = _(
    "Turns into aqua vortex,\n"
    "making rain for 5 turns.");
...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] =
{
    ...
    [MOVE_RAVINE_TERRAIN - 1] = sRAVINE_TERRAINDescription,
    [MOVE_BURNING_TERRAIN - 1] = sBURNING_TERRAINDescription,
    [MOVE_SANDY_TERRAIN - 1] = sSANDY_TERRAINDescription,
    [MOVE_SWAMP_TERRAIN - 1] = sSWAMP_TERRAINDescription,
    [MOVE_VENOMOUS_TERRAIN - 1] = sVENOMOUS_TERRAINDescription,
    [MOVE_GEOGEYSER - 1] = sGEOGEYSERDescription,
    [MOVE_ROSE_WHIP - 1] = sROSE_WHIPDescription,
    [MOVE_FEATHER_SHOT - 1] = sFEATHER_SHOTDescription,
    [MOVE_WITCHCRAFT - 1] = sWITCHCRAFTDescription,
    ...
    [MOVE_MAMMOTH_MASH - 1] = sMAMMOTH_MASHDescription,
    [MOVE_BERRY_BELLY_FLOP - 1] = sBERRY_BELLY_FLOPDescription,
    [MOVE_NAP_SLAM - 1] = sNAP_SLAMDescription,
    [MOVE_POWER_NAP - 1] = sPOWER_NAPDescription,
    [MOVE_SEISMIC_SLAM - 1] = sSEISMIC_SLAMDescription,
    [MOVE_BARRAGE_BLOW - 1] = sBARRAGE_BLOWDescription,
    [MOVE_QUEEN_ASCENDANT - 1] = sQUEEN_ASCENDANTDescription,
    [MOVE_LIVID_OUTRAGE - 1] = sLIVID_OUTRAGEDescription,
    [MOVE_AURA_CANNON - 1] = sAURA_CANNONDescription,
    [MOVE_RINGS_UNBOUND - 1] = sRINGS_UNBOUNDDescription,
    [MOVE_NOCK_LOCK - 1] = sNOCK_LOCKDescription,
    [MOVE_BLISS_ASSISTANCE - 1] = sBLISS_ASSISTANCEDescription,
    [MOVE_FAIRY_SINGULARITY - 1] = sFAIRY_SINGULARITYDescription,
    [MOVE_MIDNIGHT_SLASH - 1] = sMIDNIGHT_SLASHDescription,
    [MOVE_PHANTOM_AMBUSH - 1] = sPHANTOM_AMBUSHDescription,
    [MOVE_FLAME_SWEEP - 1] = sFLAME_SWEEPDescription,
    [MOVE_WATERBURST_SHURIKEN - 1] = sWATERBURST_SHURIKENDescription,
    [MOVE_GATLING_GULP_MISSILE - 1] = sGATLING_GULP_MISSILEDescription,
    [MOVE_DEATHROLL - 1] = sDEATHROLLDescription,
    [MOVE_UNDERGROUND_BITE - 1] = sUNDERGROUND_BITEDescription,
    [MOVE_INK_JET - 1] = sINK_JETDescription,
    [MOVE_AQUA_TORNADO - 1] = sAQUA_TORNADODescription,
};
