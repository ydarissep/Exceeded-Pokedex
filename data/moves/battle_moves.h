const struct BattleMove gBattleMoves[MOVES_COUNT] =
{
    ...
    [MOVE_AIR_CUTTER] =
    {
        ...
        .priority = 0,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_HIGH_CRIT,
        .flags2 = FLAG_GIANT_WINGS_BOOST | FLAG_BLADE_MOVE,
        .split = SPLIT_PHYSICAL,
    },
    ...
    [MOVE_SOLAR_BLADE] =
    {
        ...
        .priority = 0,
        .flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED,
        .flags2 = FLAG_WEATHER_RELATED | FLAG_BLADE_MOVE,
        .split = SPLIT_PHYSICAL,
    },
    ...
    [MOVE_SCALE_SHOT] =
    {
        .effect = EFFECT_SCALE_SHOT,   //TODO (EFFECT_MULTI_HIT + ABILITY_WEAK_ARMOR,
        .power = 25,
        .type = TYPE_DRAGON,
        .accuracy = 90,
        .pp = 20,
