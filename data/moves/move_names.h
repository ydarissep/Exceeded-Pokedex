const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_MOONGEIST_BEAM] = _("Moongest Beam"),
    ...
    [MOVE_ETERNABEAM] = _("Eternal beam"),
    ...
    [MOVE_BURNING_JEALOUSY] = _("Burning Jelosy"),
    ...
    [MOVE_KINGS_GRACE] = _("King's Grace"),
    [MOVE_FROZEN_TERRAIN] = _("Frozen Terrain"),
    [MOVE_CURSED_TERRAIN] = _("Cursed Terrain"),
    [MOVE_RAVINE_TERRAIN] = _("Ravine Terrain"),
    [MOVE_BURNING_TERRAIN] = _("Burning Terrain"),
    [MOVE_SANDY_TERRAIN] = _("Sandy Terrain"),
    [MOVE_SWAMP_TERRAIN] = _("Swamp Terrain"),
    [MOVE_VENOMOUS_TERRAIN] = _("Venomous Terrain"),
    [MOVE_GEOGEYSER] = _("Geogeyser"),
    [MOVE_ROSE_WHIP] = _("Rose Whip"),
    [MOVE_FEATHER_SHOT] = _("Feather Shot"),
    [MOVE_WITCHCRAFT] = _("Witchcraft"),
    [MOVE_EXCALIBUR] = _("Excalibur"),
    [MOVE_SHIELD_BASH] = _("Shield Bash"),
    [MOVE_DRAGON_BONE] = _("Dragon Bone"),
    [MOVE_DRACO_IMPACT] = _("Draco Impact"),
    [MOVE_BLAZING_SPIRIT] = _("Blazing Soul"),
    [MOVE_CHRISTMAS_GIFT] = _("Christmas Gift"),
    [MOVE_ARTIC_GLIDE] = _("Artic Glide"),
    [MOVE_COIN_SHOWER] = _("Coin Shower"),
    [MOVE_MAMMOTH_MASH] = _("Mammoth Mash"),
    [MOVE_BERRY_BELLY_FLOP] = _("Berry Belly Flop"),
    [MOVE_NAP_SLAM] = _("Nap Slam"),
    [MOVE_POWER_NAP] = _("Power Nap"),
    [MOVE_SEISMIC_SLAM] = _("Seismic Slam"),
    [MOVE_BARRAGE_BLOW] = _("Barrage Blow"),
    [MOVE_QUEEN_ASCENDANT] = _("Queen Ascendant"),
    [MOVE_LIVID_OUTRAGE] = _("Livid Outrage"),
    [MOVE_AURA_CANNON] = _("Aura Cannon"),
    [MOVE_RINGS_UNBOUND] = _("Rings Unbound"),
    [MOVE_NOCK_LOCK] = _("Nock Lock"),
    [MOVE_BLISS_ASSISTANCE] = _("Bliss Assistance"),
    [MOVE_FAIRY_SINGULARITY] = _("FairySingularity"),
    [MOVE_MIDNIGHT_SLASH] = _("Midnight Slash"),
    [MOVE_PHANTOM_AMBUSH] = _("Phantom Ambush"),
    [MOVE_FLAME_SWEEP] = _("Flame Sweep"),
    [MOVE_WATERBURST_SHURIKEN] = _("Waterburst Star"),
    [MOVE_GATLING_GULP_MISSILE] = _("Gatling Missile"),
    [MOVE_DEATHROLL] = _("Deathroll"),
    [MOVE_UNDERGROUND_BITE] = _("Underground Bite"),
    [MOVE_INK_JET] = _("Ink Jet"),
    [MOVE_AQUA_TORNADO] = _("Aqua Tornado"),
};
