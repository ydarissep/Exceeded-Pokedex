const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(SPIRITOMB_1, gMonFrontPic_Spiritomb),
    SPECIES_SPRITE(SPIRITOMB_2, gMonFrontPic_Spiritomb),
    SPECIES_SPRITE(SPIRITOMB_3, gMonFrontPic_Spiritomb),
    ...
    SPECIES_SPRITE(ZYGARDE_CELL, gMonFrontPic_ZygardeCell),
    SPECIES_SPRITE(ZYGARDE_CORE, gMonFrontPic_ZygardeCore),
